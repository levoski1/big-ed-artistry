...
export default function DashboardSidebar() {
  ...
  return (
    <>
      ...
      <aside className={`dashboard-sidebar ${sidebarOpen ? 'open' : ''}`} style={{ width: 260, background: 'var(--bg-card)', borderRight: '1px solid var(--border-color)', transition: 'background 0.35s ease, border-color 0.35s ease', minHeight: '100vh', padding: '32px 0', flexShrink: 0 }}>
      ...
      <div style={{ position: 'absolute', bottom: 32, left: 0, width: 260, padding: '0 24px' }}>
